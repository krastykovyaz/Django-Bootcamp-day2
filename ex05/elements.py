...
class Meta(Elem):
    def __init__(self, content=None, attr={}):
        Elem.__init__(self, tag="meta", attr=attr, content=content, tag_type='one')


class Img(Elem):
    def __init__(self, content=None, attr={}):
        Elem.__init__(self, tag="img", attr=attr, content=content, tag_type='one')
...
class Hr(Elem):
    def __init__(self, content=None, attr={}):
        Elem.__init__(self, tag="hr", attr=attr, content=content, tag_type='one')


class Br(Elem):
    def __init__(self, content=None, attr={}):
        Elem.__init__(self, tag="br", attr=attr, content=content, tag_type='one')